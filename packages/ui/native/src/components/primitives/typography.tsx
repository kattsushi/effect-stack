...
function H3({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      aria-level="3"
      className={cn('web:select-text web:scroll-m-20 font-semibold text-2xl text-foreground tracking-tight', className)}
      {...props}
    />
  )
}
...
function H4({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      aria-level="4"
      className={cn('web:select-text web:scroll-m-20 font-semibold text-foreground text-xl tracking-tight', className)}
      {...props}
    />
  )
}
...
function Large({ className, asChild = false, ...props }: TypographyProps) {
  const Component = asChild ? Slot.Text : RNText
  return <Component className={cn('web:select-text font-semibold text-foreground text-xl', className)} {...props} />
}
...
function Small({ className, asChild = false, ...props }: TypographyProps) {
  ...
  return (
    <Component
      className={cn('web:select-text font-medium text-foreground text-sm leading-none', className)}
      {...props}
    />
  )
}
