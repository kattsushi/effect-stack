import { buttonTextVariants, buttonVariants } from '@monorepo/ui-native/components/primitives/button'
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn('font-semibold native:text-xl text-foreground text-lg', className)}
      {...props}
    />
  )
}
