...
export const useMutation = <Mutation extends FunctionReference<'mutation'>, Args, Returns>({
  mutation,
  args,
  returns,
}: {
...
export const useAction = <Action extends FunctionReference<'action'>, Args, Returns>({
  action,
  args,
  returns,
}: {
