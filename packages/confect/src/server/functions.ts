...
import type { ConfectDataModelFromConfectSchema, ConfectSchemaDefinition, GenericConfectSchema } from './schema'
...
export const makeConfectFunctions = <ConfectSchema extends GenericConfectSchema>(
  ...
  const ConfectDatabaseReader = ConfectDatabaseReaderTag<ConfectSchemaDefinition<ConfectSchema>>()
  const ConfectDatabaseWriter = ConfectDatabaseWriterTag<ConfectSchemaDefinition<ConfectSchema>>()
  ...
  >({
    ...
    handler: (ctx: GenericQueryCtx<DataModel>, actualArgs: ConvexArgs): Promise<ConvexReturns> =>
      pipe(
        actualArgs,
        Schema.decode(args),
        Effect.orDie,
  ...
  >({
    ...
    args: compileArgsSchema(args),
    returns: compileReturnsSchema(returns),
    handler: (ctx: GenericMutationCtx<DataModel>, actualArgs: ConvexArgs): Promise<ConvexReturns> =>
      pipe(
        actualArgs,
        Schema.decode(args),
        Effect.orDie,
  ...
  >({
    ...
    args: compileArgsSchema(args),
    returns: compileReturnsSchema(returns),
    handler: (ctx: GenericActionCtx<DataModel>, actualArgs: ConvexValue): Promise<ConvexReturns> =>
      pipe(
        actualArgs,
        Schema.decode(args),
        Effect.orDie,
