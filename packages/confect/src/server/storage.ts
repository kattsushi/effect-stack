import type { StorageActionWriter, StorageReader, StorageWriter } from 'convex/server'
...
export class ConfectStorageReader extends Effect.Tag('@rjdellecese/confect/ConfectStorageReader')<
  ConfectStorageReader,
  ReturnType<typeof makeStorageReader>
>() {
  static readonly layer = (storageReader: StorageReader) => Layer.succeed(this, makeStorageReader(storageReader))
}

export class ConfectStorageWriter extends Effect.Tag('@rjdellecese/confect/ConfectStorageWriter')<
  ConfectStorageWriter,
  ReturnType<typeof makeStorageWriter>
>() {
  static readonly layer = (storageWriter: StorageWriter) => Layer.succeed(this, makeStorageWriter(storageWriter))
}

export class ConfectStorageActionWriter extends Effect.Tag('@rjdellecese/confect/ConfectStorageActionWriter')<
...
export class FileNotFoundError extends Schema.TaggedError<FileNotFoundError>('FileNotFoundError')('FileNotFoundError', {
  id: Schema.String,
}) {
