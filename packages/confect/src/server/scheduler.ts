...
export class ConfectScheduler extends Effect.Tag('@rjdellecese/confect/ConfectScheduler')<
  ConfectScheduler,
  ReturnType<typeof make>
>() {
  static readonly layer = (scheduler: Scheduler) => Layer.succeed(this, make(scheduler))
}
