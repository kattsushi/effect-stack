...
export type GenericConfectDocumentWithSystemFields = WithSystemFields<string, GenericConfectDoc<any, any>>

export type GenericEncodedConfectDocument = ReadonlyRecord<string, ReadonlyValue>
...
export type DataModelFromConfectDataModel<ConfectDataModel extends GenericConfectDataModel> = {
  [TableName in keyof ConfectDataModel & string]: TableInfoFromConfectTableInfo<ConfectDataModel[TableName]>
}

export type TableNamesInConfectDataModel<ConfectDataModel extends GenericConfectDataModel> = keyof ConfectDataModel &
  string

export type TableInfoFromConfectTableInfo<ConfectTableInfo extends GenericConfectTableInfo> = {
...
export type TableSchemaFromConfectTableInfo<ConfectTableInfo extends GenericConfectTableInfo> = Schema.Schema<
