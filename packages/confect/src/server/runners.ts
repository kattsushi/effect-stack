...
const makeQueryRunner =
  ...
  <Query extends FunctionReference<'query', 'public' | 'internal'>>(query: Query, ...args: OptionalRestArgs<Query>) =>
...
export const ConfectQueryRunner = Context.GenericTag<ReturnType<typeof makeQueryRunner>>(
  '@rjdellecese/confect/ConfectQueryRunner',
)
export type ConfectQueryRunner = typeof ConfectQueryRunner.Identifier

export const confectQueryRunnerLayer = (runQuery: GenericQueryCtx<any>['runQuery']) =>
  Layer.succeed(ConfectQueryRunner, makeQueryRunner(runQuery))

export const ConfectMutationRunner = Context.GenericTag<ReturnType<typeof makeMutationRunner>>(
  '@rjdellecese/confect/ConfectMutationRunner',
)
export type ConfectMutationRunner = typeof ConfectMutationRunner.Identifier

export const confectMutationRunnerLayer = (runMutation: GenericMutationCtx<any>['runMutation']) =>
  Layer.succeed(ConfectMutationRunner, makeMutationRunner(runMutation))

export const ConfectActionRunner = Context.GenericTag<ReturnType<typeof makeActionRunner>>(
  '@rjdellecese/confect/ConfectActionRunner',
)
export type ConfectActionRunner = typeof ConfectActionRunner.Identifier

export const confectActionRunnerLayer = (runAction: GenericActionCtx<any>['runAction']) =>
