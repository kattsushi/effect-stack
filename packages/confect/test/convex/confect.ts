import { ConvexActionCtx, ConvexMutationCtx, ConvexQueryCtx } from '../../src/server/ctx'
import type {
...
export type ConfectDoc<TableName extends TableNames> = ConfectDocType<ConfectDataModel, TableName>
