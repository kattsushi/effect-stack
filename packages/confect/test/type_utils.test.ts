...
describe('IsUnion', () => {
  ...
  test('string | number[] | { foo: boolean } = true', () => {
    expectTypeOf<IsUnion<string | number[] | { foo: boolean }>>().toEqualTypeOf<true>()
  })
...
describe('DeepMutable', () => {
  describe('no-op on other types', () => {
    ...
    test('{ readonly foo: readonly number[]; readonly bar: any  }', () => {
      expectTypeOf<DeepMutable<{ readonly foo: readonly number[]; readonly bar: any }>>().toEqualTypeOf<{
        foo: number[]
        bar: any
      }>()
    })
  ...
  test('ReadonlyMap', () => {
    expectTypeOf<DeepMutable<ReadonlyMap<string, number>>>().toEqualTypeOf<Map<string, number>>()
  })

  test('ReadonlySet', () => {
    expectTypeOf<DeepMutable<ReadonlySet<number>>>().toEqualTypeOf<Set<number>>()
  })

  test('ReadonlyArray', () => {
    expectTypeOf<DeepMutable<ReadonlyArray<number>>>().toEqualTypeOf<number[]>()
  })

  test('ReadonlyRecord', () => {
    expectTypeOf<DeepMutable<ReadonlyRecord<string, number>>>().toEqualTypeOf<Record<string, number>>()
  })
  ...
  test('deep readonly object', () => {
    expectTypeOf<DeepMutable<{ readonly foo: { readonly bar: readonly number[] } }>>().toEqualTypeOf<{
      foo: { bar: number[] }
    }>()
  })
...
describe('DeepReadonly', () => {
  ...
  test('Record', () => {
    expectTypeOf<DeepReadonly<Record<string, number>>>().toEqualTypeOf<ReadonlyRecord<string, number>>()
  })
...
describe('IsRecordType', () => {
  describe('true for Record types', () => {
    test('Record<string, number>', () => {
      expectTypeOf<IsRecordType<Record<string, number>>>().toEqualTypeOf<true>()
    })

    test('Record<string, string>', () => {
      expectTypeOf<IsRecordType<Record<string, string>>>().toEqualTypeOf<true>()
    })

    test('Record<string, boolean>', () => {
      expectTypeOf<IsRecordType<Record<string, boolean>>>().toEqualTypeOf<true>()
    })
    ...
    test('Record<string, unknown>', () => {
      expectTypeOf<IsRecordType<Record<string, unknown>>>().toEqualTypeOf<true>()
    })
    ...
    test('Record<string, { foo: string }>', () => {
      expectTypeOf<IsRecordType<Record<string, { foo: string }>>>().toEqualTypeOf<true>()
    })

    test('Record<string, string | number>', () => {
      expectTypeOf<IsRecordType<Record<string, string | number>>>().toEqualTypeOf<true>()
    })

    test('ReadonlyRecord<string, number>', () => {
      expectTypeOf<IsRecordType<ReadonlyRecord<string, number>>>().toEqualTypeOf<true>()
    })
  })
  ...
  describe('false for Object types', () => {
    ...
    test('{ foo: string; bar: number }', () => {
      expectTypeOf<IsRecordType<{ foo: string; bar: number }>>().toEqualTypeOf<false>()
    })

    test('{ readonly foo: string }', () => {
      expectTypeOf<IsRecordType<{ readonly foo: string }>>().toEqualTypeOf<false>()
    })
    ...
    test('{ [key: string]: string; foo: string }', () => {
      expectTypeOf<IsRecordType<{ [key: string]: string; foo: string }>>().toEqualTypeOf<false>()
    })

    test('nested object', () => {
      expectTypeOf<IsRecordType<{ foo: { bar: string } }>>().toEqualTypeOf<false>()
    })
  })
  ...
  describe('edge cases', () => {
    ...
    test('Record with non-string keys should be false', () => {
      expectTypeOf<IsRecordType<Record<number, string>>>().toEqualTypeOf<false>()
    })
  })
})
...
describe('IsRecursive', () => {
  describe('recursive types', () => {
    ...
    test('nested union array type', () => {
      type NestedUnionArray = number | string | NestedUnionArray[] | { data: NestedUnionArray }
...
describe('UnionToTuple', () => {
  ...
  test('string | number', () => {
    expectTypeOf<UnionToTuple<string | number>>().toEqualTypeOf<[string, number]>()
  })
  ...
  test('string | [number, boolean]', () => {
    expectTypeOf<UnionToTuple<string | [number, boolean]>>().toEqualTypeOf<[string, [number, boolean]]>()
  })
})
