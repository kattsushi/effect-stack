...
import type { DataModelFromConfectDataModel, GenericConfectDataModel } from '../src/server/data_model'
import {
...
const schemaToTableSchemas = <TableName extends string, TableSchema extends Schema.Schema.AnyNoContext>(
  name: TableName,
  schema: TableSchema,
) => ({
...
const systemTableSchemas = {
  _scheduled_functions: {
    withSystemFields: extendWithSystemFields(
      '_scheduled_functions',
      confectSystemSchemaDefinition.confectSchema._scheduled_functions.tableSchema,
    ),
    withoutSystemFields: confectSystemSchemaDefinition.confectSchema._scheduled_functions.tableSchema,
  },
  _storage: {
    withSystemFields: extendWithSystemFields(
      '_storage',
    ...
    withoutSystemFields: confectSystemSchemaDefinition.confectSchema._storage.tableSchema,
  },
}
