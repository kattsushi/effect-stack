...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      className={cn('web:group flex flex-1 web:list-none flex-row items-center justify-center gap-1', className)}
      {...props}
    />
  )
}
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      className={cn(
        ...
        value === itemValue ? 'web:fade-in web:animate-in' : 'web:fade-out web:animate-out',
        className,
      )}
      ref={ref}
      {...props}
