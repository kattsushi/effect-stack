...
export type ConfectDoc<TableName extends TableNames> = GenericConfectDoc<ConfectDataModel, TableName>

export const Id = <TableName extends TableNames>(tableName: TableName) => GenericId<TableName>(tableName)
